...
namespace rightBright.Services.DBus.ScreenBrightness
{
    partial class QGuiApplication : ScreenBrightnessObject
    {
        private const string Interface = "org.qtproject.Qt.QGuiApplication";
        public QGuiApplication(ScreenBrightnessService service, ObjectPath path) : base(service, path)
        { }
        ...
        public Task<string> GetApplicationDisplayNameAsync()
            => this.Connection.CallMethodAsync(CreateGetPropertyMessage(Interface, "applicationDisplayName"), (Message m, object? s) => ReadMessage_v_s(m, (ScreenBrightnessObject)s!), this);
        public Task<string> GetDesktopFileNameAsync()
            => this.Connection.CallMethodAsync(CreateGetPropertyMessage(Interface, "desktopFileName"), (Message m, object? s) => ReadMessage_v_s(m, (ScreenBrightnessObject)s!), this);
        public Task<string> GetPlatformNameAsync()
            => this.Connection.CallMethodAsync(CreateGetPropertyMessage(Interface, "platformName"), (Message m, object? s) => ReadMessage_v_s(m, (ScreenBrightnessObject)s!), this);
        public Task<bool> GetQuitOnLastWindowClosedAsync()
            => this.Connection.CallMethodAsync(CreateGetPropertyMessage(Interface, "quitOnLastWindowClosed"), (Message m, object? s) => ReadMessage_v_b(m, (ScreenBrightnessObject)s!), this);
        public Task<QGuiApplicationProperties> GetPropertiesAsync()
        {
            return this.Connection.CallMethodAsync(CreateGetAllPropertiesMessage(Interface), (Message m, object? s) => ReadMessage(m, (ScreenBrightnessObject)s!), this);
            static QGuiApplicationProperties ReadMessage(Message message, ScreenBrightnessObject _)
            {
        ...
        {
            return base.WatchPropertiesChangedAsync(Interface, (Message m, object? s) => ReadMessage(m, (ScreenBrightnessObject)s!), handler, emitOnCapturedContext, flags);
            static PropertyChanges<QGuiApplicationProperties> ReadMessage(Message message, ScreenBrightnessObject _)
            {
                var reader = message.GetBodyReader();
    ...
    partial class QCoreApplication : ScreenBrightnessObject
    {
        private const string __Interface = "org.qtproject.Qt.QCoreApplication";
        public QCoreApplication(ScreenBrightnessService service, ObjectPath path) : base(service, path)
        { }
        ...
        public Task<string> GetApplicationNameAsync()
            => this.Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "applicationName"), (Message m, object? s) => ReadMessage_v_s(m, (ScreenBrightnessObject)s!), this);
        public Task<string> GetApplicationVersionAsync()
            => this.Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "applicationVersion"), (Message m, object? s) => ReadMessage_v_s(m, (ScreenBrightnessObject)s!), this);
        public Task<string> GetOrganizationNameAsync()
            => this.Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "organizationName"), (Message m, object? s) => ReadMessage_v_s(m, (ScreenBrightnessObject)s!), this);
        public Task<string> GetOrganizationDomainAsync()
            => this.Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "organizationDomain"), (Message m, object? s) => ReadMessage_v_s(m, (ScreenBrightnessObject)s!), this);
        public Task<bool> GetQuitLockEnabledAsync()
            => this.Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "quitLockEnabled"), (Message m, object? s) => ReadMessage_v_b(m, (ScreenBrightnessObject)s!), this);
        public Task<QCoreApplicationProperties> GetPropertiesAsync()
        {
            return this.Connection.CallMethodAsync(CreateGetAllPropertiesMessage(__Interface), (Message m, object? s) => ReadMessage(m, (ScreenBrightnessObject)s!), this);
            static QCoreApplicationProperties ReadMessage(Message message, ScreenBrightnessObject _)
            {
                var reader = message.GetBodyReader();
                return ReadProperties(ref reader);
            }
        ...
        {
            return base.WatchPropertiesChangedAsync(__Interface, (Message m, object? s) => ReadMessage(m, (ScreenBrightnessObject)s!), handler, emitOnCapturedContext, flags);
            static PropertyChanges<QCoreApplicationProperties> ReadMessage(Message message, ScreenBrightnessObject _)
            {
                var reader = message.GetBodyReader();
                reader.ReadString(); // interface
                List<string> changed = new(), invalidated = new();
    ...
    partial class PowerManagement : ScreenBrightnessObject
    {
        private const string __Interface = "org.freedesktop.PowerManagement";
        public PowerManagement(ScreenBrightnessService service, ObjectPath path) : base(service, path)
        { }
        ...
        {
            return this.Connection.CallMethodAsync(CreateMessage(), (Message m, object? s) => ReadMessage_b(m, (ScreenBrightnessObject)s!), this);
            MessageBuffer CreateMessage()
            {
                var writer = this.Connection.GetMessageWriter();
                writer.WriteMethodCallHeader(
        ...
        public ValueTask<IDisposable> WatchCanSuspendChangedAsync(Action<Exception?, bool> handler, bool emitOnCapturedContext = true, ObserverFlags flags = ObserverFlags.None)
            => base.WatchSignalAsync(Service.Destination, __Interface, Path, "CanSuspendChanged", (Message m, object? s) => ReadMessage_b(m, (ScreenBrightnessObject)s!), handler, emitOnCapturedContext, flags);
        public ValueTask<IDisposable> WatchCanHibernateChangedAsync(Action<Exception?, bool> handler, bool emitOnCapturedContext = true, ObserverFlags flags = ObserverFlags.None)
            => base.WatchSignalAsync(Service.Destination, __Interface, Path, "CanHibernateChanged", (Message m, object? s) => ReadMessage_b(m, (ScreenBrightnessObject)s!), handler, emitOnCapturedContext, flags);
        public ValueTask<IDisposable> WatchCanHybridSuspendChangedAsync(Action<Exception?, bool> handler, bool emitOnCapturedContext = true, ObserverFlags flags = ObserverFlags.None)
            => base.WatchSignalAsync(Service.Destination, __Interface, Path, "CanHybridSuspendChanged", (Message m, object? s) => ReadMessage_b(m, (ScreenBrightnessObject)s!), handler, emitOnCapturedContext, flags);
        public ValueTask<IDisposable> WatchCanSuspendThenHibernateChangedAsync(Action<Exception?, bool> handler, bool emitOnCapturedContext = true, ObserverFlags flags = ObserverFlags.None)
            => base.WatchSignalAsync(Service.Destination, __Interface, Path, "CanSuspendThenHibernateChanged", (Message m, object? s) => ReadMessage_b(m, (ScreenBrightnessObject)s!), handler, emitOnCapturedContext, flags);
        public ValueTask<IDisposable> WatchPowerSaveStatusChangedAsync(Action<Exception?, bool> handler, bool emitOnCapturedContext = true, ObserverFlags flags = ObserverFlags.None)
            => base.WatchSignalAsync(Service.Destination, __Interface, Path, "PowerSaveStatusChanged", (Message m, object? s) => ReadMessage_b(m, (ScreenBrightnessObject)s!), handler, emitOnCapturedContext, flags);
    }
    partial class Inhibit : ScreenBrightnessObject
    {
        private const string __Interface = "org.freedesktop.PowerManagement.Inhibit";
        public Inhibit(ScreenBrightnessService service, ObjectPath path) : base(service, path)
        { }
        public Task<uint> InhibitAsync(string application, string reason)
        {
            return this.Connection.CallMethodAsync(CreateMessage(), (Message m, object? s) => ReadMessage_u(m, (ScreenBrightnessObject)s!), this);
            MessageBuffer CreateMessage()
            {
                var writer = this.Connection.GetMessageWriter();
                writer.WriteMethodCallHeader(
        ...
        public ValueTask<IDisposable> WatchHasInhibitChangedAsync(Action<Exception?, bool> handler, bool emitOnCapturedContext = true, ObserverFlags flags = ObserverFlags.None)
            => base.WatchSignalAsync(Service.Destination, __Interface, Path, "HasInhibitChanged", (Message m, object? s) => ReadMessage_b(m, (ScreenBrightnessObject)s!), handler, emitOnCapturedContext, flags);
    }
    record ScreenBrightnessProperties
    {
        public string[] DisplaysDBusNames { get; set; } = default!;
    }
    partial class ScreenBrightness : ScreenBrightnessObject
    {
        private const string __Interface = "org.kde.ScreenBrightness";
        public ScreenBrightness(ScreenBrightnessService service, ObjectPath path) : base(service, path)
        { }
        ...
        public ValueTask<IDisposable> WatchDisplayAddedAsync(Action<Exception?, string> handler, bool emitOnCapturedContext = true, ObserverFlags flags = ObserverFlags.None)
            => base.WatchSignalAsync(Service.Destination, __Interface, Path, "DisplayAdded", (Message m, object? s) => ReadMessage_s(m, (ScreenBrightnessObject)s!), handler, emitOnCapturedContext, flags);
        public ValueTask<IDisposable> WatchDisplayRemovedAsync(Action<Exception?, string> handler, bool emitOnCapturedContext = true, ObserverFlags flags = ObserverFlags.None)
            => base.WatchSignalAsync(Service.Destination, __Interface, Path, "DisplayRemoved", (Message m, object? s) => ReadMessage_s(m, (ScreenBrightnessObject)s!), handler, emitOnCapturedContext, flags);
        public ValueTask<IDisposable> WatchBrightnessChangedAsync(Action<Exception?, (string DisplayDbusName, int Brightness, string SourceClientName, string SourceClientContext)> handler, bool emitOnCapturedContext = true, ObserverFlags flags = ObserverFlags.None)
            => base.WatchSignalAsync(Service.Destination, __Interface, Path, "BrightnessChanged", (Message m, object? s) => ReadMessage_siss(m, (ScreenBrightnessObject)s!), handler, emitOnCapturedContext, flags);
        public ValueTask<IDisposable> WatchBrightnessRangeChangedAsync(Action<Exception?, (string DisplayDbusName, int MaxBrightness, int Brightness)> handler, bool emitOnCapturedContext = true, ObserverFlags flags = ObserverFlags.None)
            => base.WatchSignalAsync(Service.Destination, __Interface, Path, "BrightnessRangeChanged", (Message m, object? s) => ReadMessage_sii(m, (ScreenBrightnessObject)s!), handler, emitOnCapturedContext, flags);
        public Task<string[]> GetDisplaysDBusNamesAsync()
            => this.Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "DisplaysDBusNames"), (Message m, object? s) => ReadMessage_v_as(m, (ScreenBrightnessObject)s!), this);
        public Task<ScreenBrightnessProperties> GetPropertiesAsync()
        {
            return this.Connection.CallMethodAsync(CreateGetAllPropertiesMessage(__Interface), (Message m, object? s) => ReadMessage(m, (ScreenBrightnessObject)s!), this);
            static ScreenBrightnessProperties ReadMessage(Message message, ScreenBrightnessObject _)
            {
                var reader = message.GetBodyReader();
                return ReadProperties(ref reader);
            }
        ...
        {
            return base.WatchPropertiesChangedAsync(__Interface, (Message m, object? s) => ReadMessage(m, (ScreenBrightnessObject)s!), handler, emitOnCapturedContext, flags);
            static PropertyChanges<ScreenBrightnessProperties> ReadMessage(Message message, ScreenBrightnessObject _)
            {
                var reader = message.GetBodyReader();
                reader.ReadString(); // interface
                List<string> changed = new(), invalidated = new();
    ...
    partial class Display : ScreenBrightnessObject
    {
        private const string __Interface = "org.kde.ScreenBrightness.Display";
        public Display(ScreenBrightnessService service, ObjectPath path) : base(service, path)
        { }
        ...
        public Task<string> GetLabelAsync()
            => this.Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "Label"), (Message m, object? s) => ReadMessage_v_s(m, (ScreenBrightnessObject)s!), this);
        public Task<bool> GetIsInternalAsync()
            => this.Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "IsInternal"), (Message m, object? s) => ReadMessage_v_b(m, (ScreenBrightnessObject)s!), this);
        public Task<int> GetMaxBrightnessAsync()
            => this.Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "MaxBrightness"), (Message m, object? s) => ReadMessage_v_i(m, (ScreenBrightnessObject)s!), this);
        public Task<int> GetBrightnessAsync()
            => this.Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "Brightness"), (Message m, object? s) => ReadMessage_v_i(m, (ScreenBrightnessObject)s!), this);
        public Task<DisplayProperties> GetPropertiesAsync()
        {
            return this.Connection.CallMethodAsync(CreateGetAllPropertiesMessage(__Interface), (Message m, object? s) => ReadMessage(m, (ScreenBrightnessObject)s!), this);
            static DisplayProperties ReadMessage(Message message, ScreenBrightnessObject _)
            {
                var reader = message.GetBodyReader();
                return ReadProperties(ref reader);
            }
        ...
        {
            return base.WatchPropertiesChangedAsync(__Interface, (Message m, object? s) => ReadMessage(m, (ScreenBrightnessObject)s!), handler, emitOnCapturedContext, flags);
            static PropertyChanges<DisplayProperties> ReadMessage(Message message, ScreenBrightnessObject _)
            {
                var reader = message.GetBodyReader();
                reader.ReadString(); // interface
                List<string> changed = new(), invalidated = new();
    ...
    partial class PowerManagement0 : ScreenBrightnessObject
    {
        private const string __Interface = "org.kde.Solid.PowerManagement";
        public PowerManagement0(ScreenBrightnessService service, ObjectPath path) : base(service, path)
        { }
        ...
        {
            return this.Connection.CallMethodAsync(CreateMessage(), (Message m, object? s) => ReadMessage_s(m, (ScreenBrightnessObject)s!), this);
            MessageBuffer CreateMessage()
            {
                var writer = this.Connection.GetMessageWriter();
                writer.WriteMethodCallHeader(
        ...
        {
            return this.Connection.CallMethodAsync(CreateMessage(), (Message m, object? s) => ReadMessage_t(m, (ScreenBrightnessObject)s!), this);
            MessageBuffer CreateMessage()
            {
                var writer = this.Connection.GetMessageWriter();
                writer.WriteMethodCallHeader(
        ...
        {
            return this.Connection.CallMethodAsync(CreateMessage(), (Message m, object? s) => ReadMessage_i(m, (ScreenBrightnessObject)s!), this);
            MessageBuffer CreateMessage()
            {
                var writer = this.Connection.GetMessageWriter();
                writer.WriteMethodCallHeader(
        ...
        public ValueTask<IDisposable> WatchProfileChangedAsync(Action<Exception?, string> handler, bool emitOnCapturedContext = true, ObserverFlags flags = ObserverFlags.None)
            => base.WatchSignalAsync(Service.Destination, __Interface, Path, "profileChanged", (Message m, object? s) => ReadMessage_s(m, (ScreenBrightnessObject)s!), handler, emitOnCapturedContext, flags);
        ...
        public ValueTask<IDisposable> WatchBatteryRemainingTimeChangedAsync(Action<Exception?, ulong> handler, bool emitOnCapturedContext = true, ObserverFlags flags = ObserverFlags.None)
            => base.WatchSignalAsync(Service.Destination, __Interface, Path, "batteryRemainingTimeChanged", (Message m, object? s) => ReadMessage_t(m, (ScreenBrightnessObject)s!), handler, emitOnCapturedContext, flags);
        public ValueTask<IDisposable> WatchSmoothedBatteryRemainingTimeChangedAsync(Action<Exception?, ulong> handler, bool emitOnCapturedContext = true, ObserverFlags flags = ObserverFlags.None)
            => base.WatchSignalAsync(Service.Destination, __Interface, Path, "smoothedBatteryRemainingTimeChanged", (Message m, object? s) => ReadMessage_t(m, (ScreenBrightnessObject)s!), handler, emitOnCapturedContext, flags);
        public ValueTask<IDisposable> WatchLidClosedChangedAsync(Action<Exception?, bool> handler, bool emitOnCapturedContext = true, ObserverFlags flags = ObserverFlags.None)
            => base.WatchSignalAsync(Service.Destination, __Interface, Path, "lidClosedChanged", (Message m, object? s) => ReadMessage_b(m, (ScreenBrightnessObject)s!), handler, emitOnCapturedContext, flags);
        public ValueTask<IDisposable> WatchBatteryConservationModeChangedAsync(Action<Exception?, bool> handler, bool emitOnCapturedContext = true, ObserverFlags flags = ObserverFlags.None)
            => base.WatchSignalAsync(Service.Destination, __Interface, Path, "batteryConservationModeChanged", (Message m, object? s) => ReadMessage_b(m, (ScreenBrightnessObject)s!), handler, emitOnCapturedContext, flags);
        public ValueTask<IDisposable> WatchChargeStartThresholdChangedAsync(Action<Exception?, int> handler, bool emitOnCapturedContext = true, ObserverFlags flags = ObserverFlags.None)
            => base.WatchSignalAsync(Service.Destination, __Interface, Path, "chargeStartThresholdChanged", (Message m, object? s) => ReadMessage_i(m, (ScreenBrightnessObject)s!), handler, emitOnCapturedContext, flags);
        public ValueTask<IDisposable> WatchChargeStopThresholdChangedAsync(Action<Exception?, int> handler, bool emitOnCapturedContext = true, ObserverFlags flags = ObserverFlags.None)
            => base.WatchSignalAsync(Service.Destination, __Interface, Path, "chargeStopThresholdChanged", (Message m, object? s) => ReadMessage_i(m, (ScreenBrightnessObject)s!), handler, emitOnCapturedContext, flags);
    ...
    partial class BrightnessControl : ScreenBrightnessObject
    {
        private const string __Interface = "org.kde.Solid.PowerManagement.Actions.BrightnessControl";
        public BrightnessControl(ScreenBrightnessService service, ObjectPath path) : base(service, path)
        { }
        ...
        public ValueTask<IDisposable> WatchBrightnessChangedAsync(Action<Exception?, int> handler, bool emitOnCapturedContext = true, ObserverFlags flags = ObserverFlags.None)
            => base.WatchSignalAsync(Service.Destination, __Interface, Path, "brightnessChanged", (Message m, object? s) => ReadMessage_i(m, (ScreenBrightnessObject)s!), handler, emitOnCapturedContext, flags);
        public ValueTask<IDisposable> WatchBrightnessMaxChangedAsync(Action<Exception?, int> handler, bool emitOnCapturedContext = true, ObserverFlags flags = ObserverFlags.None)
            => base.WatchSignalAsync(Service.Destination, __Interface, Path, "brightnessMaxChanged", (Message m, object? s) => ReadMessage_i(m, (ScreenBrightnessObject)s!), handler, emitOnCapturedContext, flags);
        public ValueTask<IDisposable> WatchBrightnessMinChangedAsync(Action<Exception?, int> handler, bool emitOnCapturedContext = true, ObserverFlags flags = ObserverFlags.None)
            => base.WatchSignalAsync(Service.Destination, __Interface, Path, "brightnessMinChanged", (Message m, object? s) => ReadMessage_i(m, (ScreenBrightnessObject)s!), handler, emitOnCapturedContext, flags);
    }
    partial class HandleButtonEvents : ScreenBrightnessObject
    {
        private const string __Interface = "org.kde.Solid.PowerManagement.Actions.HandleButtonEvents";
        public HandleButtonEvents(ScreenBrightnessService service, ObjectPath path) : base(service, path)
        { }
        ...
        public ValueTask<IDisposable> WatchTriggersLidActionChangedAsync(Action<Exception?, bool> handler, bool emitOnCapturedContext = true, ObserverFlags flags = ObserverFlags.None)
            => base.WatchSignalAsync(Service.Destination, __Interface, Path, "triggersLidActionChanged", (Message m, object? s) => ReadMessage_b(m, (ScreenBrightnessObject)s!), handler, emitOnCapturedContext, flags);
    }
    partial class PowerProfile : ScreenBrightnessObject
    {
        private const string __Interface = "org.kde.Solid.PowerManagement.Actions.PowerProfile";
        public PowerProfile(ScreenBrightnessService service, ObjectPath path) : base(service, path)
        { }
        ...
        {
            return this.Connection.CallMethodAsync(CreateMessage(), (Message m, object? s) => ReadMessage_as(m, (ScreenBrightnessObject)s!), this);
            MessageBuffer CreateMessage()
            {
                var writer = this.Connection.GetMessageWriter();
                writer.WriteMethodCallHeader(
        ...
        {
            return this.Connection.CallMethodAsync(CreateMessage(), (Message m, object? s) => ReadMessage_aaesv(m, (ScreenBrightnessObject)s!), this);
            MessageBuffer CreateMessage()
            {
                var writer = this.Connection.GetMessageWriter();
                writer.WriteMethodCallHeader(
        ...
        public ValueTask<IDisposable> WatchConfiguredProfileChangedAsync(Action<Exception?, string> handler, bool emitOnCapturedContext = true, ObserverFlags flags = ObserverFlags.None)
            => base.WatchSignalAsync(Service.Destination, __Interface, Path, "configuredProfileChanged", (Message m, object? s) => ReadMessage_s(m, (ScreenBrightnessObject)s!), handler, emitOnCapturedContext, flags);
        public ValueTask<IDisposable> WatchCurrentProfileChangedAsync(Action<Exception?, string> handler, bool emitOnCapturedContext = true, ObserverFlags flags = ObserverFlags.None)
            => base.WatchSignalAsync(Service.Destination, __Interface, Path, "currentProfileChanged", (Message m, object? s) => ReadMessage_s(m, (ScreenBrightnessObject)s!), handler, emitOnCapturedContext, flags);
        public ValueTask<IDisposable> WatchProfileChoicesChangedAsync(Action<Exception?, string[]> handler, bool emitOnCapturedContext = true, ObserverFlags flags = ObserverFlags.None)
            => base.WatchSignalAsync(Service.Destination, __Interface, Path, "profileChoicesChanged", (Message m, object? s) => ReadMessage_as(m, (ScreenBrightnessObject)s!), handler, emitOnCapturedContext, flags);
        public ValueTask<IDisposable> WatchPerformanceInhibitedReasonChangedAsync(Action<Exception?, string> handler, bool emitOnCapturedContext = true, ObserverFlags flags = ObserverFlags.None)
            => base.WatchSignalAsync(Service.Destination, __Interface, Path, "performanceInhibitedReasonChanged", (Message m, object? s) => ReadMessage_s(m, (ScreenBrightnessObject)s!), handler, emitOnCapturedContext, flags);
        public ValueTask<IDisposable> WatchPerformanceDegradedReasonChangedAsync(Action<Exception?, string> handler, bool emitOnCapturedContext = true, ObserverFlags flags = ObserverFlags.None)
            => base.WatchSignalAsync(Service.Destination, __Interface, Path, "performanceDegradedReasonChanged", (Message m, object? s) => ReadMessage_s(m, (ScreenBrightnessObject)s!), handler, emitOnCapturedContext, flags);
        public ValueTask<IDisposable> WatchProfileHoldsChangedAsync(Action<Exception?, Dictionary<string, VariantValue>[]> handler, bool emitOnCapturedContext = true, ObserverFlags flags = ObserverFlags.None)
            => base.WatchSignalAsync(Service.Destination, __Interface, Path, "profileHoldsChanged", (Message m, object? s) => ReadMessage_aaesv(m, (ScreenBrightnessObject)s!), handler, emitOnCapturedContext, flags);
    }
    partial class SuspendSession : ScreenBrightnessObject
    {
        private const string __Interface = "org.kde.Solid.PowerManagement.Actions.SuspendSession";
        public SuspendSession(ScreenBrightnessService service, ObjectPath path) : base(service, path)
        { }
    ...
    partial class PolicyAgent : ScreenBrightnessObject
    {
        private const string __Interface = "org.kde.Solid.PowerManagement.PolicyAgent";
        public PolicyAgent(ScreenBrightnessService service, ObjectPath path) : base(service, path)
        { }
        ...
        {
            return this.Connection.CallMethodAsync(CreateMessage(), (Message m, object? s) => ReadMessage_aess(m, (ScreenBrightnessObject)s!), this);
            MessageBuffer CreateMessage()
            {
                var writer = this.Connection.GetMessageWriter();
                writer.WriteMethodCallHeader(
        ...
        public ValueTask<IDisposable> WatchInhibitionsChangedAsync(Action<Exception?, (Dictionary<string, string> Added, string[] Removed)> handler, bool emitOnCapturedContext = true, ObserverFlags flags = ObserverFlags.None)
            => base.WatchSignalAsync(Service.Destination, __Interface, Path, "InhibitionsChanged", (Message m, object? s) => ReadMessage_aessas(m, (ScreenBrightnessObject)s!), handler, emitOnCapturedContext, flags);
        public ValueTask<IDisposable> WatchPermanentlyBlockedInhibitionsChangedAsync(Action<Exception?, (Dictionary<string, string> Added, Dictionary<string, string> Removed)> handler, bool emitOnCapturedContext = true, ObserverFlags flags = ObserverFlags.None)
            => base.WatchSignalAsync(Service.Destination, __Interface, Path, "PermanentlyBlockedInhibitionsChanged", (Message m, object? s) => ReadMessage_aessaess(m, (ScreenBrightnessObject)s!), handler, emitOnCapturedContext, flags);
        public ValueTask<IDisposable> WatchTemporarilyBlockedInhibitionsChangedAsync(Action<Exception?, (Dictionary<string, string> Added, Dictionary<string, string> Removed)> handler, bool emitOnCapturedContext = true, ObserverFlags flags = ObserverFlags.None)
            => base.WatchSignalAsync(Service.Destination, __Interface, Path, "TemporarilyBlockedInhibitionsChanged", (Message m, object? s) => ReadMessage_aessaess(m, (ScreenBrightnessObject)s!), handler, emitOnCapturedContext, flags);
    }
    partial class Application : ScreenBrightnessObject
    {
        private const string __Interface = "org.freedesktop.Application";
        public Application(ScreenBrightnessService service, ObjectPath path) : base(service, path)
        { }
    ...
    partial class KDBusService : ScreenBrightnessObject
    {
        private const string __Interface = "org.kde.KDBusService";
        public KDBusService(ScreenBrightnessService service, ObjectPath path) : base(service, path)
        { }
    ...
    partial class ScreenBrightnessService
    {
        public Tmds.DBus.Protocol.Connection Connection { get; }
        public string Destination { get; }
        public ScreenBrightnessService(Tmds.DBus.Protocol.Connection connection, string destination)
    ...
    class ScreenBrightnessObject
    {
        public ScreenBrightnessService Service { get; }
        public ObjectPath Path { get; }
        protected Tmds.DBus.Protocol.Connection Connection => Service.Connection;
        protected ScreenBrightnessObject(ScreenBrightnessService service, ObjectPath path)
        ...
        protected static string ReadMessage_v_s(Message message, ScreenBrightnessObject _)
        {
            var reader = message.GetBodyReader();
            reader.ReadSignature("s"u8);
            return reader.ReadString();
        }
        protected static bool ReadMessage_v_b(Message message, ScreenBrightnessObject _)
        {
            var reader = message.GetBodyReader();
            reader.ReadSignature("b"u8);
            return reader.ReadBool();
        }
        protected static bool ReadMessage_b(Message message, ScreenBrightnessObject _)
        {
            var reader = message.GetBodyReader();
            return reader.ReadBool();
        }
        protected static uint ReadMessage_u(Message message, ScreenBrightnessObject _)
        {
            var reader = message.GetBodyReader();
            return reader.ReadUInt32();
        }
        protected static string ReadMessage_s(Message message, ScreenBrightnessObject _)
        {
            var reader = message.GetBodyReader();
            return reader.ReadString();
        }
        protected static (string, int, string, string) ReadMessage_siss(Message message, ScreenBrightnessObject _)
        {
            var reader = message.GetBodyReader();
        ...
        protected static (string, int, int) ReadMessage_sii(Message message, ScreenBrightnessObject _)
        {
            var reader = message.GetBodyReader();
            var arg0 = reader.ReadString();
            var arg1 = reader.ReadInt32();
        ...
        protected static string[] ReadMessage_v_as(Message message, ScreenBrightnessObject _)
        {
            var reader = message.GetBodyReader();
            reader.ReadSignature("as"u8);
            return reader.ReadArrayOfString();
        }
        protected static int ReadMessage_v_i(Message message, ScreenBrightnessObject _)
        {
            var reader = message.GetBodyReader();
            reader.ReadSignature("i"u8);
            return reader.ReadInt32();
        }
        protected static ulong ReadMessage_t(Message message, ScreenBrightnessObject _)
        {
            var reader = message.GetBodyReader();
            return reader.ReadUInt64();
        }
        protected static int ReadMessage_i(Message message, ScreenBrightnessObject _)
        {
            var reader = message.GetBodyReader();
            return reader.ReadInt32();
        }
        protected static string[] ReadMessage_as(Message message, ScreenBrightnessObject _)
        {
            var reader = message.GetBodyReader();
            return reader.ReadArrayOfString();
        }
        protected static Dictionary<string, VariantValue>[] ReadMessage_aaesv(Message message, ScreenBrightnessObject _)
        {
            var reader = message.GetBodyReader();
            return ReadType_aaesv(ref reader);
        }
        protected static Dictionary<string, string> ReadMessage_aess(Message message, ScreenBrightnessObject _)
        {
            var reader = message.GetBodyReader();
            return ReadType_aess(ref reader);
        }
        protected static (Dictionary<string, string>, string[]) ReadMessage_aessas(Message message, ScreenBrightnessObject _)
        {
            var reader = message.GetBodyReader();
        ...
        protected static (Dictionary<string, string>, Dictionary<string, string>) ReadMessage_aessaess(Message message, ScreenBrightnessObject _)
        {
            var reader = message.GetBodyReader();
            var arg0 = ReadType_aess(ref reader);
