namespace ScreenBrightness.DBus
{
    using System;
    ...
    {
        public string ApplicationDisplayName { get; set; } = default!;
        public string DesktopFileName { get; set; } = default!;
        public string PlatformName { get; set; } = default!;
        public bool QuitOnLastWindowClosed { get; set; } = default!;
    }
    partial class QGuiApplication : ScreenBrightnessObject
    {
        private const string __Interface = "org.qtproject.Qt.QGuiApplication";
        ...
        public Task<string> GetApplicationDisplayNameAsync()
            => this.Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "applicationDisplayName"), (Message m, object? s) => ReadMessage_v_s(m, (ScreenBrightnessObject)s!), this);
        public Task<string> GetDesktopFileNameAsync()
            => this.Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "desktopFileName"), (Message m, object? s) => ReadMessage_v_s(m, (ScreenBrightnessObject)s!), this);
        public Task<string> GetPlatformNameAsync()
            => this.Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "platformName"), (Message m, object? s) => ReadMessage_v_s(m, (ScreenBrightnessObject)s!), this);
        public Task<bool> GetQuitOnLastWindowClosedAsync()
            => this.Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "quitOnLastWindowClosed"), (Message m, object? s) => ReadMessage_v_b(m, (ScreenBrightnessObject)s!), this);
