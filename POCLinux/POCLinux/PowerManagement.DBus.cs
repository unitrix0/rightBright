namespace PowerManagement.DBus
{
    using System;
    ...
    partial class QGuiApplication : PowerManagementObject
    {
        ...
        public Task<string> GetApplicationDisplayNameAsync()
            => this.Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "applicationDisplayName"), (Message m, object? s) => ReadMessage_v_s(m, (PowerManagementObject)s!), this);
        public Task<string> GetDesktopFileNameAsync()
            => this.Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "desktopFileName"), (Message m, object? s) => ReadMessage_v_s(m, (PowerManagementObject)s!), this);
        public Task<string> GetPlatformNameAsync()
            => this.Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "platformName"), (Message m, object? s) => ReadMessage_v_s(m, (PowerManagementObject)s!), this);
        public Task<bool> GetQuitOnLastWindowClosedAsync()
            => this.Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "quitOnLastWindowClosed"), (Message m, object? s) => ReadMessage_v_b(m, (PowerManagementObject)s!), this);
